...
|---|---|---|---|---|
| Client SDK | TypeScript | [`@autoark-ai/eva-client-sdk-ts@0.0.7-dev`](https://www.npmjs.com/package/@autoark-ai/eva-client-sdk-ts/v/0.0.7-dev) | [`browser-conversation-agent`](client-sdk/ts/browser-conversation-agent/) | 浏览器端语音、多轮对话、TTS、麦克风控制，以及可选 Emotion、Command 与摄像头图片问答 |
