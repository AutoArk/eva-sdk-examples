...
|---|---|---|---|---|
| Client SDK | TypeScript | [`@autoark-ai/eva-client-sdk-ts@1.0.1`](https://www.npmjs.com/package/@autoark-ai/eva-client-sdk-ts/v/1.0.1) | [`browser-conversation-agent`](client-sdk/ts/browser-conversation-agent/) | 浏览器端语音、多轮对话、TTS、麦克风控制，以及可选 Emotion、Command 与摄像头图片问答 |
