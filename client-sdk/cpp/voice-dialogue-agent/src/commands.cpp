...
eva::CommandRegistration make_clock_command() {
  ...
  registration.handler = [](const eva::CommandCall &,
                            const eva::CommandContext &,
    ...
    data.emplace("unix_ms",
                 eva::JsonValue(static_cast<std::int64_t>(milliseconds)));
